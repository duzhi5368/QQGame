...
DECLARE_MODULE_HELPER(TCPSocket,NETWORK_SERVICE_DLL_NAME,_T("CreateTCPSocket"))
DECLARE_MODULE_HELPER(NetworkManager,NETWORK_SERVICE_DLL_NAME,_T("CreateNetworkManager"))
