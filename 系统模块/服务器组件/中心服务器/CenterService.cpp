...
bool CCenterService::StartService()
{
    ...
    //_tcscpy(m_InitParamter.m_szServerDataBaseAddr, _T("127.0.0.1"));
    //_tcscpy(m_InitParamter.m_szServerDataBaseUser, _T("sa"));
    //_tcscpy(m_InitParamter.m_szServerDataBasePass, _T("123456@zxc"));
    ...
    if (m_TCPNetworkEngine->SetServiceParameter(wServicePort, wMaxConnect) == false) 
        return false;
