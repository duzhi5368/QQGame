...
bool __cdecl CTCPNetworkEngine::StartService()
{
	...
	try
	{
        ...
        int on = 1;
        //reuse address by zhangyl
        setsockopt(m_hServerSocket, SOL_SOCKET, SO_REUSEADDR, (char *)&on, sizeof(on));
        //setsockopt(m_hServerSocket, SOL_SOCKET, SO_REUSEPORT, (char *)&on, sizeof(on));
