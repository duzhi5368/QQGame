...
DECLARE_MODULE_HELPER(SkinResource,SKIN_RESOURCE_DLL_NAME,_T("CreateSkinResource"))
DECLARE_MODULE_HELPER(PlatformResource, SKIN_RESOURCE_DLL_NAME, _T("CreatePlatformResource"))
