...
//////////////////////////////////////////////////////////////////////////
	...
	static const GUID IID_ITCPSocketEvent={0x0602c2de,0x69b1,0x4136,0x00af,0x30,0x2d,0x2d,0x1e,0x35,0x51,0x24};
#else
	#define VER_ITCPSocketEvent INTERFACE_VERSION(1,1)
...
DECLARE_MODULE_HELPER(DataBase, KERNEL_ENGINE_DLL_NAME, _T("CreateDataBase"))
DECLARE_MODULE_HELPER(TimerEngine,KERNEL_ENGINE_DLL_NAME,_T("CreateTimerEngine"))
DECLARE_MODULE_HELPER(DataBaseEngine, KERNEL_ENGINE_DLL_NAME, _T("CreateDataBaseEngine"))
DECLARE_MODULE_HELPER(AttemperEngine, KERNEL_ENGINE_DLL_NAME, _T("CreateAttemperEngine"))
DECLARE_MODULE_HELPER(TCPSocketService, KERNEL_ENGINE_DLL_NAME, _T("CreateTCPSocketService"))
DECLARE_MODULE_HELPER(TCPNetworkEngine, KERNEL_ENGINE_DLL_NAME, _T("CreateTCPNetworkEngine"))
DECLARE_MODULE_HELPER(AsynchronismEngine, KERNEL_ENGINE_DLL_NAME, _T("CreateAsynchronismEngine"))
DECLARE_MODULE_HELPER(TraceServiceManager, KERNEL_ENGINE_DLL_NAME, _T("CreateTraceServiceManager"))
